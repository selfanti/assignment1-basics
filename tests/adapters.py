...
def run_get_batch(
    ...
    """
    from cs336_basics.data import data_load
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.optimizer import cos_lr
    return cos_lr(it,max_learning_rate,min_learning_rate,warmup_iters,cosine_cycle_iters)
